                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                ...
                                <a href="{{ route('home.create') }}" class="btn btn-primary btn-sm float-right">Tambah</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('home/' . $row->image) }}" width="100px" height="100px" alt="{{ $row->title }}">
                                            </td>
                                            <td>
                                                <strong>{{ $row->title }}</strong><br>
                                            </td>
                                            <td>
                                                <strong>{{ $row->subtitle }}</strong><br>
                                            </td>
